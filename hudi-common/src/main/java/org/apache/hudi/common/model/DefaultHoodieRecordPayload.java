...
public class DefaultHoodieRecordPayload extends OverwriteWithLatestAvroPayload {
  ...
  public Option<IndexedRecord> combineAndGetUpdateValue(IndexedRecord currentValue, Schema schema, Properties properties) throws IOException {
    ...
    if (noNeedUpdatePersistedRecord(currentValue, incomingRecord, properties)) {
  ...
  protected boolean noNeedUpdatePersistedRecord(IndexedRecord currentValue,
    ...
    Comparable incomingOrderingVal = (Comparable) getNestedFieldVal((GenericRecord) incomingRecord, properties.getProperty(HoodiePayloadProps.PAYLOAD_ORDERING_FIELD_PROP), false);
